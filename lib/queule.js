...
var QueuleYield = Class.create({
   ...
   */
  up: function() {
    // var previous = element.previous('yield');
    // if (previous != undefined) up.show();
    // else up.hide();
    // if (element.next('yield') != undefined) down.show();
    // else down.hide();
  },
  /**
...
var QueuleUse = Class.create({
  initialize: function(element) {
    ...
    var thisObject = this;
    this.element.childElements().reverse().each( function(element) {
      if (element.tagName == 'YIELD') {
	var item = new QueuleYield(element, thisObject);
	if (thisObject.top == undefined) thisObject.top = item;
	else thisObject.top = thisObject.top.push(item);
      }
    });
  ...
  insert: function(element) {
    ...
    if (this.top == undefined) this.top = yieldElement;
    else this.top = this.top.push(yieldElement);
