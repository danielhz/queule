...
var QueuleYield = Class.create({
  ...
  setupFieldContainer: function() {
    ...
    this.fieldElement.addClassName('queule-field-container').update(this.element.innerHTML);
    this.element.update('').insert(this.fieldElement);
  ...
  setupActionContainer: function() {
    ...
    this.element.insert(this.actionContainer);
  },
  /**
  ...
  setupUpdateLink: function() {
    var thisObject = this;
    this.updateLink = new Element('a', {'class':'queule-update','href':'#','title':'edit'} );
  ...
  setupDeleteLink: function() {
    var thisObject = this;
    this.deleteLink = new Element('a', {'class':'queule-delete','href':'#','title':'delete'});
  ...
  setupSaveLink: function() {
    var thisObject = this;
    this.saveLink = new Element('a', {'class':'queule-save','href':'#'}).update('(save)');
  ...
  setupCancelLink: function() {
    var thisObject = this;
    this.cancelLink = new Element('a', {'class':'queule-cancel','href':'#'}).update('(cancel)');
...
var QueuleBasicType = Class.create({
   ...
   */
  display: function() {
    var a = new Element('a', {'href':'#','title':'edit'}).update(this.value);
